...
class CancelBookings extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Refound Request (Admin)'),
      ...
      body: StreamBuilder<QuerySnapshot>(
        ...
        builder: (context, snapshot) {
          ...
          if (!snapshot.hasData || snapshot.data!.docs.isEmpty) {
            return const Center(child: Text('No Redound Request found.'));
          }
...
Widget showStatusPaymentDialog(
  ...
  return AlertDialog(
    ...
    content: Text(
      "Are you sure the payment have been refunded?",
      ...
      ElevatedButton.icon(
        ...
        onPressed: () async {
          try {
              ...
              await docRef.update({'status': 'Refounded'});
